...
class TextProcessor(IDocumentProcessor):
    ...
    async def _create_fixed_size_chunks(self, document: Document, content: str, 
    ...
    async def _create_paragraph_chunks(self, document: Document, content: str, 
    ...
    async def _create_sentence_chunks(self, document: Document, content: str, 
                                    max_size: int) -> List[DocumentChunk]:
        """创建句子块"""
        chunks = []
