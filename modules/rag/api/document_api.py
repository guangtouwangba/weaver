...
async def create_document(
    ...
    try:
        async with service:
            ...
            return APIResponse(success=True, message="文档创建成功", data=document)
...
async def update_document(
    ...
    try:
        async with service:
            ...
            return APIResponse(success=True, message="文档更新成功", data=document)
    except HTTPException:
        raise
    except Exception as e:
...
async def list_documents(
    ...
    try:
        async with service:
            ...
            return APIResponse(success=True, data=document_list)
    except Exception as e:
...
async def process_document(
    ...
    try:
        ...
        async with service:
            ...
            return APIResponse(success=True, message="文档处理完成", data=result)
    except ValueError as e:
        raise HTTPException(status_code=400, detail=str(e))
    except Exception as e:
...
async def get_file_documents(
    file_id: str, service: DocumentService = Depends(get_document_service)
):
    """获取文件的文档列表"""
    try:
        async with service:
