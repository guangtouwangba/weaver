...
from ..tasks.base import (
    ITaskService, ITaskHandler, ITaskRegistry,
    TaskStatus, TaskPriority, TaskConfig, TaskResult, TaskProgress,
...
class CeleryTaskService(ITaskService):
    ...
    def __init__(self,
        ...
        if not CELERY_AVAILABLE:
            raise TaskError("Celery not available. Please install celery: pip install celery[redis]")
...
def task_handler(task_name: str, 
    ...
    def decorator(handler_class: Type[ITaskHandler]):
        ...
        handler_class.task_config = property(lambda self: TaskConfig(
