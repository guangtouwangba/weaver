...
from ..tasks.orchestrator import orchestrator, WorkflowDefinition, TaskDefinition
...
class WorkflowService(BaseService):
    ...
    async def create_document_only(self,
                                 file_id: str,
                                 document_data: Dict[str, Any],
    ...
    async def process_rag_only(self,
                             document_id: str,
                             file_path: str,
...
# 便利函数
async def start_document_processing_workflow(file_id: str,
                                           document_data: Dict[str, Any],
                                           **kwargs) -> str:
    """便利函数：启动文档处理工作流"""
