...
from .enums import ContentType, ChunkingStrategy, SearchType, ProcessingStatus
...
class UploadUrlRequest(BaseSchema):
    ...
    filename: str = Field(
        min_length=1,
        description="文件名",
        example="machine_learning_algorithms.pdf"
    )
