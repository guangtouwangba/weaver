...
## Purpose
The system SHALL provide a centralized prompt template management system using Jinja2 templates to separate prompt content from code logic, enabling easier maintenance, reusability, and future localization.
