...
## Phase 4: Validation
- [x] Add unit test for `SynthesisAgent` verifying the multi-step execution flow.
- [x] Verify manually on canvas that progress messages update and result quality is improved.
