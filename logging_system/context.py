...
@contextmanager
def request_context(
    request_id: str = None, user_id: str = None, operation: str = None
...
@contextmanager
def task_context(
    task_id: str, task_name: str, queue: str = None
) -> Generator[LogContext, None, None]:
    """
    ...
    """
    with log_context(
        correlation_id=task_id, operation=task_name, component="task", queue=queue
    ) as ctx:
        yield ctx
