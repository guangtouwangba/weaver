...
Provides multiple log formatters supporting different output formats and scenarios.
"""
...
class RequestFormatter(BaseFormatter):
    """HTTP request specialized formatter"""
...
class CompactFormatter(BaseFormatter):
    ...
    def format(self, record: LogRecord) -> str:
        ...
        # Only add exception information on errors
