...
class StorageConfig:
    ...
    def from_env(cls) -> "StorageConfig":
        ...
        return cls(
            ...
            multipart_threshold=int(os.getenv("STORAGE_MULTIPART_THRESHOLD", str(64 * 1024 * 1024))),
            multipart_chunksize=int(os.getenv("STORAGE_MULTIPART_CHUNKSIZE", str(16 * 1024 * 1024))),
            max_concurrency=int(os.getenv("STORAGE_MAX_CONCURRENCY", "10")),
            
            presigned_url_expires=int(os.getenv("STORAGE_PRESIGNED_URL_EXPIRES", "3600")),
