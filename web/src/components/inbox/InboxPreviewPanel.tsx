...
import InboxActionFooter from './InboxActionFooter';
...
export default function InboxPreviewPanel({
    item, onEdit, onDelete, onAddToProject, onCreateProject
    ...
    return (
        <Box sx={{ flex: 1, display: 'flex', flexDirection: 'column', height: 'calc(100vh - 64px)', overflow: 'hidden', bgcolor: '#F9FAFB' }}>
            ...
            {/* Action Footer */}
            <InboxActionFooter onAddToProject={onAddToProject} onCreateProject={onCreateProject} />
