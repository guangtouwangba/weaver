...
def upgrade():
    ...
    access_level_enum = postgresql.ENUM(
        "private", "public_read", "shared", "authenticated", name="access_level_enum"
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "applies_to_categories", postgresql.ARRAY(sa.String()), nullable=True
        ),
        sa.Column(
            "applies_to_content_types", postgresql.ARRAY(sa.String()), nullable=True
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "files_by_status", postgresql.JSONB(astext_type=sa.Text()), nullable=True
        ),
        sa.Column(
        ...
        sa.PrimaryKeyConstraint(
            "stat_date", "stat_type", "dimension", "dimension_value"
        ),
    )
    ...
    op.create_index(
        "idx_files_metadata_gin", "files", ["custom_metadata"], postgresql_using="gin"
    )
    ...
    op.create_index(
        "idx_upload_sessions_user_status", "upload_sessions", ["user_id", "status"]
    )
    op.create_index(
        "idx_upload_sessions_file_status", "upload_sessions", ["file_id", "status"]
    )
    ...
    op.create_index(
        "idx_access_policies_base_access_level",
        "access_policies",
        ["base_access_level"],
    )
    ...
    op.create_index(
        "idx_access_policies_file_ids_gin",
        "access_policies",
        ["applies_to_file_ids"],
        postgresql_using="gin",
    )
    op.create_index(
        "idx_access_policies_categories_gin",
        "access_policies",
        ["applies_to_categories"],
        postgresql_using="gin",
    )
    op.create_index(
        "idx_access_policies_content_types_gin",
        "access_policies",
        ["applies_to_content_types"],
        postgresql_using="gin",
    )
    op.create_index(
        "idx_access_policies_conditions_gin",
        "access_policies",
        ["conditions"],
        postgresql_using="gin",
    )
    ...
    op.create_index(
        "idx_file_access_logs_access_timestamp",
        "file_access_logs",
        ["access_timestamp"],
    )
    op.create_index(
        "idx_file_access_logs_ip_address", "file_access_logs", ["ip_address"]
    )
    op.create_index(
        "idx_file_access_logs_access_granted", "file_access_logs", ["access_granted"]
    )
    op.create_index(
        "idx_file_access_logs_file_timestamp",
        "file_access_logs",
        ["file_id", "access_timestamp"],
    )
    op.create_index(
        "idx_file_access_logs_user_timestamp",
        "file_access_logs",
        ["user_id", "access_timestamp"],
    )
    op.create_index(
        "idx_file_access_logs_action_timestamp",
        "file_access_logs",
        ["action", "access_timestamp"],
    )
    op.create_index(
        "idx_file_access_logs_data_gin",
        "file_access_logs",
        ["additional_data"],
        postgresql_using="gin",
    )
    ...
    op.create_index(
        "idx_file_stats_date_type", "file_stats", ["stat_date", "stat_type"]
    )
    op.create_index(
        "idx_file_stats_dimension", "file_stats", ["dimension", "dimension_value"]
    )
    ...
    op.execute(
        "ALTER TABLE upload_sessions ALTER COLUMN status SET DEFAULT 'initiated';"
    )
    ...
    op.execute(
        "ALTER TABLE file_access_logs ALTER COLUMN access_granted SET DEFAULT true;"
    )
...
def downgrade():
    ...
    op.drop_index(
        "idx_file_access_logs_action_timestamp", table_name="file_access_logs"
    )
    ...
    op.drop_index(
        "idx_file_access_logs_access_timestamp", table_name="file_access_logs"
    )
