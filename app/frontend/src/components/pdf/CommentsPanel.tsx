...
export default function CommentsPanel({ documentId }: CommentsPanelProps) {
    ...
    const CommentItem = ({ comment, isReply = false, parentId }: {
        ...
        return (
            <div className={`${isReply ? 'ml-6 border-l-2 border-gray-100 pl-4' : ''}`}>
                <div className="group py-3">
                    ...
                    <div className="flex items-center gap-2 mb-1">
                        ...
                        <button
                            ...
                            className="ml-auto opacity-0 group-hover:opacity-100 p-1 text-gray-400 hover:text-red-500 transition-opacity"
                        >
                            <Trash2 size={14} />
                        </button>
                    </div>
