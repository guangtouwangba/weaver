...
SETTING_METADATA = {
    ...
    "document_processing_mode": {
        "category": SettingCategory.RAG_STRATEGY,
        "description": "Document processing quality vs speed tradeoff",
        "default": "standard",
        "allowed_values": ["fast", "standard", "quality"],
        "options": [
            {
                "value": "fast",
                "label": "Fast",
                "description": "Quick text extraction, no OCR. Best for text-based documents.",
                "cost": "free",
                "performance": "fastest",
                "best_for": "Text PDFs, Word documents, presentations",
            },
            {
                "value": "standard",
                "label": "Standard (Recommended)",
                "description": "Auto-detects scanned documents and applies OCR when needed.",
                "cost": "low",
                "performance": "medium",
                "best_for": "Mixed document types, general use",
            },
            {
                "value": "quality",
                "label": "Quality (GPU)",
                "description": "GPU-accelerated OCR with structure preservation. Higher cost but best quality.",
                "cost": "high",
                "performance": "fast",
                "best_for": "Scanned documents, images, complex layouts, academic papers",
            },
        ],
    },
    # Advanced
