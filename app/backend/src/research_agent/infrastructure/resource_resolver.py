...
class ResourceResolver:
    ...
    async def resolve(
        self,
        resource_id: UUID,
        type_hint: Optional[ResourceType] = None,
    ...
    async def _get_document_by_id(self, doc_id: UUID) -> Optional[DocumentModel]:
        """Get DocumentModel by ID."""
        return await self._session.get(DocumentModel, doc_id)
    
    async def _get_url_content_by_id(self, url_id: UUID) -> Optional[UrlContentModel]:
